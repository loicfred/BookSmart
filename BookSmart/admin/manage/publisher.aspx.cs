...
namespace BookSmart.admin.manage {
    public partial class publisher : System.Web.UI.Page {
        PublisherObj currentItem = new PublisherObj();

        protected void Page_Load(object sender, EventArgs e) {
            if (Request.QueryString["id"] != null) {
                currentItem = PublisherObj.getPublisherById(int.Parse(Request.QueryString["id"]));
                if (!IsPostBack)
                    LoadDetails();
            }
            if (!IsPostBack) {
        ...
        protected void btnNew_Click(object sender, EventArgs e) {
            Response.Redirect("/admin/manage/publisher.aspx");
        }
        ...
        protected void OtherItems_SelectedIndexChanged(object sender, EventArgs e) {
            Response.Redirect("/admin/manage/publisher.aspx?id=" + OtherItems.SelectedValue);
        }
    }
}